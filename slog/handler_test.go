...
import (
	...
	"github.com/bluzelle/go-exp/slog/internal/buffer"
)
...
func TestJSONAndTextHandlers(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			wantJSON:  `{"source":{"function":"github.com/bluzelle/go-exp/slog.TestJSONAndTextHandlers","file":"handler_test.go","line":$LINE},"msg":"message"}`,
		},
	} {
