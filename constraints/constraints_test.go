...
import "github.com/bluzelle/go-exp/constraints"
...
func TestFailure(t *testing.T) {
	...
	// This package is github.com/bluzelle/go-exp/constraints, so the root of the x/exp
...
replace github.com/bluzelle/go-exp => %s
`, expModDir)
